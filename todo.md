...
- [ ] Re-run full validation, checkpoint, and fast-forward only the verified public GitHub main branch; verify matching SHA, clean tree, public visibility, and a successful remote Verify run.
