...
- [ ] Add and validate a GitHub Actions continuous-integration workflow that runs the supported pnpm audit, typecheck, tests, and production build on pushes and pull requests to `main`.
